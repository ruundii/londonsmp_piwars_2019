...
class Motor:
    ...
    def __init__(self, motor_left_in1 = 27, motor_left_in2 = 22, motor_left_en = 19,
                 motor_right_in1 = 17, motor_right_in2 = 4, motor_right_en = 12):
    ...
    def __get_pwm_from_motor_speed(self, speed):
        if speed == 0:
            ...
            return max(-2 + speed*0.98, -100)
        else:
            return min(2 + speed*0.98, 100)
